export const serviceAdminPrivilegedActions = [
...
export const identityPermissionRoleCatalog = [
    {
        key: "employee",
...
export const identityServiceAdminTariffCatalog = [
    { id: "starter", name: "Start", priceMonthly: 39000, includedUsers: 3, workspaceLimit: 3, retentionDays: 30, automationRuns: 20000, features: ["Shared inbox", "Basic reports", "Email support"], changePolicy: "Immediate downgrade is available during trial only." },
    { id: "business", name: "Business", priceMonthly: 129000, includedUsers: 15, workspaceLimit: 10, retentionDays: 180, automationRuns: 150000, features: ["SLA routing", "AI suggestions", "Audit export", "Priority support"], changePolicy: "Changes apply next billing period unless explicitly confirmed." },
    { id: "scale", name: "Scale", priceMonthly: 380000, includedUsers: 35, workspaceLimit: 20, retentionDays: 365, automationRuns: 600000, features: ["Webhook replay", "Advanced routing", "Feature flags", "Dedicated CSM"], changePolicy: "Requires reason and billing approval preview." },
    { id: "enterprise", name: "Enterprise", priceMonthly: 990000, includedUsers: 70, workspaceLimit: 40, retentionDays: 1095, automationRuns: 2500000, features: ["SAML", "Regional data storage", "Custom limits", "Incident bridge 24/7"], changePolicy: "Requires written confirmation and service-admin audit." }
];
