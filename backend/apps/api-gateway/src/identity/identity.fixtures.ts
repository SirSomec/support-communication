...
export const permissionRoles = [
  ...
  },
  {
    ...
    aliases: ["senior", "senior_operator", "lead", "СЃС‚Р°СЂС€РёР№", "СЃС‚Р°СЂС€РёР№ СЃРѕС‚СЂСѓРґРЅРёРє"],
  ...
  },
  {
    ...
    actions: ["*"],
    aliases: ["admin", "administrator", "service_admin", "Р°РґРјРёРЅ", "Р°РґРјРёРЅРёСЃС‚СЂР°С‚РѕСЂ"],
    groupIds: ["admins"],
    metadata: {}
  }
];
