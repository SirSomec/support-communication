...
function additionalAuthenticatedData(keyVersion) {
    return Buffer.from(`provider-credential:${ENVELOPE_VERSION}:${keyVersion}`, "utf8");
}
function decodeEnvelopePart(value, expectedLength) {
...
export class ProviderConnectionCrypto {
    ...
    static fromEnvironment(keyVersion, environment = process.env) {
...
//# sourceMappingURL=provider-connection-crypto.js.map