...
import { Cable, ListChecks, Mail, PlugZap, ShieldCheck, Tags, TerminalSquare, UsersRound, Webhook } from "lucide-react";
...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "mail", label: "Служебная почта", hint: "SMTP для 2FA, восстановления и приглашений", icon: Mail },
