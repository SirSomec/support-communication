...
import { createOpenAiCompatibleEmbeddingProvider } from "../ai-connections/openai-compatible-embedding.provider.js";
import { estimateCorpusTokens, lexicalRelevance, lexicalTerms } from "./knowledge-corpus.js";
/**
...
export class EmbeddingVectorCache {
    ...
    static clearDefault() { EmbeddingVectorCache.shared = null; }
    get(model, contentHash) {
...
export class SemanticKnowledgeSearchService {
    ...
    providerFactory;
    vectors;
    constructor(connections = AiConnectionRepository.default(), environment = process.env, usage = AiUsageRepository.default(), providerFactory = createOpenAiCompatibleEmbeddingProvider, vectors = EmbeddingVectorCache.default()) {
    ...
    async search(input) {
        ...
        if (!connection)
            throw new Error("semantic_retrieval_connection_not_ready");
        ...
        try {
            ...
            const passages = input.corpus.chunks
                .map((chunk, index) => {
...
//# sourceMappingURL=semantic-knowledge-search.service.js.map