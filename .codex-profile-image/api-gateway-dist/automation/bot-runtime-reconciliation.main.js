...
export async function runBotRuntimeReconciliationFromEnv(source = process.env, argv = process.argv) {
    ...
    const input = {
        ...
        closeConversation: (payload, scope) => conversationService.transitionConversationStatus({ ...payload, nextStatus: "closed" }, scope),
...
//# sourceMappingURL=bot-runtime-reconciliation.main.js.map