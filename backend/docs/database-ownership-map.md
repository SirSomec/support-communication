...
| `platform-admin-service` | Service-admin audit, impersonation, audit exports, redactions, break-glass approvals and platform-wide service mail settings | `service_admin_audit_events`, `service_admin_audit_exports`, `service_admin_audit_redactions`, `service_admin_impersonations`, `break_glass_approvals`, `service_mail_settings` | Phase 1 slice 1.5 and Phase 10 slices 10.6-10.8 for cross-surface hardening |
