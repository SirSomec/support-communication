...
- Общие UI-примитивы и Toast вынесены в `src/ui.jsx`.
...
2. Вынести общие компоненты `Modal`, `ToolbarSearch`, `EntityTable`, `SegmentedControl`, `StatusBadge`, `AuditTimeline`, `ActionMenu`; `Toast` уже вынесен в `src/ui.jsx`.
