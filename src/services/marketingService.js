...
export const marketingService = {
  ...
  getClientPreferences: (clientId, conversationId) => apiRequest(`/marketing/clients/${encodeURIComponent(clientId)}/preferences`, { operation: "getMarketingClientPreferences", query: conversationId ? { conversationId } : undefined, service: SERVICE }),
