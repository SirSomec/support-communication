...
export const CSAT_FEEDBACK_PROMPT_TEXT = "Спасибо за оценку! Хотите оставить комментарий — напишите его следующим сообщением, мы передадим его команде. Чтобы задать новый вопрос, нажмите «Новое обращение».";
...
export function conversationCsatFeedback(conversation) {
...
export function isAwaitingCsatFeedback(conversation, nowMs = Date.now()) {
...
export function withCsatFeedback(conversation, feedback) {
    return {
        ...conversation,
        metadata: {
...
export function csatFeedbackConversationMutation(conversation, eventType, data = {}) {
...
//# sourceMappingURL=csat-feedback.js.map