 ...
 */
export function extractAiDirectives(text) {
...
export class AiBotResponseService {
    ...
    llmSearch;
    semanticSearch;
    constructor(connections = AiConnectionRepository.default(), sources = KnowledgeSourceRepository.default(), workspace = WorkspaceRepository.default(), environment = process.env, usage = AiUsageRepository.default(), sessions = AgentSessionStateRepository.default(), mcpConnectors = new McpReadOnlyConnectorService(new HttpMcpReadOnlyTransport(), 8_000, McpConnectorRepository.default()), llmSearch = new LlmKnowledgeSearchService(), semanticSearch = new SemanticKnowledgeSearchService()) {
    ...
    async materials(tenantId, bindings, question, scenarioId, scoreThreshold, mode) {
    ...
    mcpInvoker() {
        return {
            invoke: (tenantId, connectorId, toolName, toolInput) => this.mcpConnectors.invoke(tenantId, connectorId, toolName, toolInput)
        };
    }
}
...
export function extractRelevantKnowledge(document, question, budget) {
...
//# sourceMappingURL=ai-bot-response.service.js.map