        ...
        <div className="api-docs-content">
          ...
          <section className="api-docs-section" id="marketing">
            ...
            <div className="api-docs-info-row">
              ...
              <div><strong><code>PATCH /marketing/clients/:id/channel-restriction</code></strong><span>Устанавливает или снимает запрет коммуникаций по одному каналу. Запрет имеет приоритет над согласием и глобальной отправкой без согласия; изменение фиксируется в аудите.</span></div>
            </div>
