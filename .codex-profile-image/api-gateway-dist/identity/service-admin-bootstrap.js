...
export async function bootstrapServiceAdminFromEnv(source = process.env, repository = IdentityRepository.default()) {
...
function serviceAdminSubjectId(email) {
    return `svc-admin-${createHash("sha256").update(email).digest("hex").slice(0, 12)}`;
}
//# sourceMappingURL=service-admin-bootstrap.js.map