...
export class TopicDirectoryRepository {
    adapter;
    constructor(adapter) {
...
export function seedTopicDirectoryRecords() {
    const rows = [
...
function topic(id, groupName, branchName, name, channels, required, archived, routingTarget, accessScope, sortOrder) {
    return {
        accessScope,
        archived,
        branchName,
...
//# sourceMappingURL=topic-directory.repository.js.map