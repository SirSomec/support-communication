...
>
> Статусы 🟡 в таблице ниже отражают готовность артефактов в репозитории, а не развёртывание на текущем прод-сервере. Полный отчёт: [`infrastructure-audit-2026-07-28.md`](infrastructure-audit-2026-07-28.md).
