...
export class McpConnectorsController {
  ...
  @Get() @RequireServiceAdminAction("knowledge.sources.write") @ApiOkResponse({ description: "Tenant MCP connector metadata; no credentials or headers" })
  list(@Param("tenantId") tenantId: string) { return this.service.list(tenantId); }
  @Post() @RequireServiceAdminAction("knowledge.sources.write") @HttpCode(HttpStatus.OK)
  ...
  @Patch(":connectorId") @RequireServiceAdminAction("knowledge.sources.write") @HttpCode(HttpStatus.OK)
  ...
  @Post(":connectorId/approve") @RequireServiceAdminAction("knowledge.sources.write") @HttpCode(HttpStatus.OK)
  ...
  @Post(":connectorId/enable") @RequireServiceAdminAction("knowledge.sources.write") @HttpCode(HttpStatus.OK)
  ...
  @Post(":connectorId/disable") @RequireServiceAdminAction("knowledge.sources.write") @HttpCode(HttpStatus.OK)
