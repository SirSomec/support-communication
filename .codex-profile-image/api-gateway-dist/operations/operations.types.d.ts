...
export interface WorkerObservability {
    ...
    evidenceSource: "automation.proactiveDeliveryAttempts" | "integration.publicDemoRequestNotificationDescriptors" | "integration.webhookDeliveryJournal" | "database.billingSyncJobs" | "database.outboxEvents" | "notifications.deliveryDescriptors" | "reports.exportJobs" | "reports.scheduledDigestDescriptors";
    health: {
        reason: string;
