...
export function buildStatusPageExternalIdempotencyKey(scope, target) {
    return `status-page:${scope}:${target}`;
}
export function sanitizeStatusPagePublisherFailure(error) {
    if (error instanceof Error) {
        return redactSensitiveText(error.message);
    }
    return redactSensitiveText(String(error));
}
export function createDeterministicStatusPagePublisherAdapter(options = {}) {
    return {
...
export function createRuntimeHttpStatusPagePublisherAdapter(options) {
...
export async function publishIncidentStatusPageCommunication(input) {
...
export async function publishPlatformAlertStatusPageCommunication(input) {
...
export async function executeStatusPageSyncOutboxWorker(input) {
...
function statusPageRequestFromOutbox(outbox) {
...
function withPublishedAt(publisher, publishedAt) {
...
function makeDeterministicExternalId(target, scope) {
...
//# sourceMappingURL=status-page-publisher.adapter.js.map