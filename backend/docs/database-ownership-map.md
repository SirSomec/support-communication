...
| `automation-bot-service` | Bot scenarios, runtime versions, proactive execution, SDK invitation exposure lifecycle and bot handoff events | `bot_scenarios`, `bot_scenario_versions`, `bot_publish_audit_events`, `automation_publish_idempotency_keys`, `automation_bot_test_runs`, `proactive_rules`, `proactive_execution_windows`, `proactive_frequency_caps`, `proactive_experiment_assignments`, `proactive_delivery_attempts`, `proactive_delivery_idempotency_keys`, `proactive_delivery_attributions`, `proactive_exposures` | Automation runtime persistence has Prisma parity; provider/runtime smoke remains Phase 9 work |
