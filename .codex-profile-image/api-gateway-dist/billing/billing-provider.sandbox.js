...
export class SandboxBillingProvider {
    providerName = "sandbox-billing-provider";
...
function normalizeSubscription(subscription, tenant, provider, now) {
...
function normalizeInvoice(invoice, tenant, subscription, provider, now) {
...
export function createBillingProvider(mode) {
    return new SandboxBillingProvider();
}
//# sourceMappingURL=billing-provider.sandbox.js.map