...
function resolveConversationRepositoryKind(source: ConversationRepositoryBootstrapSource): "json" | "prisma" {
  return resolveRepositoryKind(source, "CONVERSATION_REPOSITORY");
}
