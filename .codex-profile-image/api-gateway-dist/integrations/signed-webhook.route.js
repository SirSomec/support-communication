...
import { createVerifiedInboundWebhookNormalizationDescriptor } from "./signed-webhook-verifier.js";
export async function normalizeSignedInboundWebhookFromRoute(input) {
    ...
    const normalized = await input.conversationService.normalizeInboundEvent(descriptorResult.descriptor.channel, descriptorResult.descriptor.normalizationPayload);
...
function signedWebhookErrorMessage(code) {
    const messages = {
...
//# sourceMappingURL=signed-webhook.route.js.map