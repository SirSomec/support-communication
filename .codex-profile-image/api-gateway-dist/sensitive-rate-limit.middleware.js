...
export async function sensitiveRateLimitMiddleware(request, response, next) {
...
export function selectSensitiveRateLimitPolicy(method, originalUrl) {
...
export function rateLimitKey(policy, dimension, value) {
...
async function increment(client, key, windowSeconds) {
...
function policy(name, path, ipLimit, accountLimit, windowSeconds) {
    return { accountLimit, ipLimit, name, path, windowSeconds };
}
function respond(response, status, code, message, retryAfter) {
...
//# sourceMappingURL=sensitive-rate-limit.middleware.js.map