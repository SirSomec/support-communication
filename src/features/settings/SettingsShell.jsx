...
import { Cable, ListChecks, ShieldCheck, Tags, Users, UsersRound } from "lucide-react";
...
const navGroups = [
  {
    ...
    label: "Интеграции",
    items: [
      { id: "connections", label: "Центр интеграций", hint: "Все продукты, API и очереди в одном месте", icon: Cable }
    ]
  },
  {
    id: "team",
    label: "Команда",
    items: [
      { id: "employees", label: "Сотрудники и роли", hint: "Доступы, роли и лимиты", icon: UsersRound },
      { id: "groups", label: "Группы", hint: "Состав команд и каналы", icon: Users },
