export const integrationProducts = [
  ...
  {
    id: "sdk",
    name: "Чат на сайте или в приложении",
    description: "Добавьте чат на сайт по готовой инструкции или откройте SDK для мобильного приложения.",
    requirement: "Для сайта достаточно доступа к его коду; для приложения понадобится разработчик.",
    kind: "technical",
