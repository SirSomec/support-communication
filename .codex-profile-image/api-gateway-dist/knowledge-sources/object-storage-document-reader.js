...
export function createObjectStorageDocumentReader(options = {}) {
    const signer = options.signer ?? createObjectStorageSigner();
    ...
    return {
        async read(input) {
            ...
            try {
                ...
                if (!response.ok || length > input.maxBytes)
                    throw new Error("knowledge_document_read_rejected");
...
//# sourceMappingURL=object-storage-document-reader.js.map