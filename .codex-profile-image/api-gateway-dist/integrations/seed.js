import { activeSecuritySessions, apiChangelog, apiEnvironmentKeys, channelDetails, securityAlerts, securityControls, webhookDeliveryLog, webhookEndpoints } from "./seed-catalog.js";
function clone(value) {
    return JSON.parse(JSON.stringify(value));
}
export function bootstrapIntegrationWorkspaceCatalog() {
    return {
...
export function bootstrapIntegrationState(base) {
    return {
...
function seedChannelConnections() {
