export const routingOperatorFixtures = [
    {
        id: "operator-ivan",
        name: "Ivan P.",
        status: "online",
...
export const routingQueueFixtures = [
...
export const routingConversationFixtures = [
    {
        id: "vladimir",
        client: "Vladimir B.",
        channel: "Telegram",
...
export const rescueReportSeedRows = [
    {
...
//# sourceMappingURL=routing.fixtures.js.map