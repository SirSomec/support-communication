...
- ConversationList/TabButton, ChatPane, CustomerPanel/PanelSection/InfoRow, DialogModals, Composer, inline AI panel и attachment preview вынесены в `src/features/dialogs/*` без изменения smoke-селекторов; CSS модалок DialogModals вынесен в `src/features/dialogs/dialog-modals.css`.
